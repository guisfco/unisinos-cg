...
string objFile = "../models/SuzanneTriTextured.obj", mtlFile = "../materials/SuzanneTriTextured.mtl", curvesFile = "../curves.txt";
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Tarefa M6 -- Guilherme", nullptr, nullptr);
